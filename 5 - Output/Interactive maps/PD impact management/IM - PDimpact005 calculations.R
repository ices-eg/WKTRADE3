...
Region010_T1 <- raster::aggregate(Region010) #; save(Region010,file=("Region010.RData"))
Region020_T1 <- raster::aggregate(Region020) #; save(Region020,file=("Region020.RData"))
Region030_T1 <- raster::aggregate(Region030) #; save(Region030,file=("Region030.RData"))
...
Region060_T1 <- raster::aggregate(Region060) #; save(Region060,file=("Region060.RData"))
...
Region090_T1 <- raster::aggregate(Region090) #; save(Region090,file=("Region090.RData"))
...
Region_below_T1 <- raster::aggregate(Region_below)
Region_above_T1 <- raster::aggregate(Region_above)
