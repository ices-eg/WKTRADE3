...
#### Figure 9
```{r echo=FALSE, message=FALSE, fig.align = 'center',fig.cap="**Figure 9. Impact of mobile bottom-contacting gears averaged for the 2013-2018 six-year cycle for the PD and L1 method.**"}
knitr::include_graphics(paste(outputs,ecoregion,"_figureA5.png",sep=''))
```

#### Figure 10
```{r echo=FALSE, message=FALSE,fig.align = 'center', out.width='70%', fig.cap="**Figure 10. The mean impact of mobile bottom-contacting gears in all combined MSFD habitats and the four most extensive habitat types between 2009 and 2018 (left). The proportion of the fished area with an impact of less than 0.2 (right)**"}
