...
# Celtic seas subdivision
  ...
  Region@data$division[Region@data$OSPARreg == "L2.2.6"] <- "channel_CS"  
  ...
  Region@data$division[Region@data$OSPARreg == "L2.2.4"] <- "shetland_CS" 
  Region@data$division[Region@data$OSPARreg == "L2.2.7"] <- "shetland_CS" 
  Region@data$division[Region@data$OSPARreg == "L2.2.9"] <- "shetland_CS" 
...
# Baltic seas subdivision
  ...
  Region@data$division <- NA
  Region@data$division[Region@data$HELCOMreg == "Ã.land Sea"] <- "Aland_BS" 
...
# BoB-IC subdivisions
  ...
  Region@data$division[Region@data$Depth > -200 & Region@data$lat < 41 & Region@data$EEZ == "Portugal" ] <- "ShallowSouth_IC"
